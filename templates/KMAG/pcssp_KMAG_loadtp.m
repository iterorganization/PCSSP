function TP = pcssp_KMAG_loadtp()
% Setup tunable control params default values for KMAG module

%
%  WRITTEN BY:  Gianmaria De Tommasi ON 13/11/18
% ADAPTED BY: TR on 25/4/2023
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Module configuration parameters
% Controller sampling time (s)
% November 2018 -> IO suggested to use 500 Hz as reference sampling time for
% the magnetic control
% config.Ts = 2e-3; now defined in obj


% MIMO magnetic controller
KeMag_temp(:,:,1) = [-0.2867    0.3491   -1.0960   -0.6198    0.1582    0.0138   -0.7993    0.0500   -0.3375    1.0797
